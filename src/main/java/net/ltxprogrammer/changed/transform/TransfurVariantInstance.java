...
import net.ltxprogrammer.changed.enchantments.FormFittingEnchantment;
...
public abstract class TransfurVariantInstance<T extends ChangedEntity> {
    ...
    public static void onEntityRightClick(PlayerInteractEvent.EntityInteract event) {
        ...
        ProcessTransform.ifPlayerTransfurred(event.getPlayer(), variant -> {
    ...
    public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
        ...
        ProcessTransform.ifPlayerTransfurred(event.player, instance -> {
            if (ChangedCompatibility.isPlayerUsedByOtherMod(event.player)) {
                ProcessTransform.removePlayerTransfurVariant(event.player);
                return;
            }
    ...
    public static void onPlayerDeath(LivingDeathEvent event) {
        if (event.getEntityLiving() instanceof Player player) {
            ProcessTransform.ifPlayerTransfurred(player, instance -> {
                instance.setDead();
